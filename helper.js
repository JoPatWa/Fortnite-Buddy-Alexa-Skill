    ...
    return FortniteBuddy = {
        weeklyChallenges: {
            week: {
                ...
                seven: {
                    list: {
                        title: "Season 4 - Week 7 Challenges",
                        all: "Deal 250 damage with a Pickaxe to opponents, Search 7 Chests in Risky Reels, Consume 20 Foraged items, Score a goal on 3 different pitches, Follow the treasure map found in still being determined, 5 Assault Rifle eliminations, Eliminate 3 opponents in Shifty Shafts",
                        challenge1: "Deal 250 damage with a Pickaxe to opponents",
                        challenge2: "Search 7 Chests in Risky Reels",
                        challenge3: "Consume 20 Foraged items",
                        challenge4: "Score a goal on 3 different pitches",
                        challenge5: "Follow the treasure map found in still being determined",
                        challenge6: "5 Assault Rifle eliminations",
                        challenge7: "Eliminate 3 opponents in Shifty Shafts"
                    }
                }
            }
        }
...
exports.getArray = function (arrayName) {
    if (arrayName === "challengesArray") {
        ...
        return greetingsArray = [
            ...
            "Fortnite Buddy Dropper feature is here! Say... where we dropping boys or...random drop spot -- to hear a location.",
